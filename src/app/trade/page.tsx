      ...
      <Table className="mt-6">
        <TableHead>
          <TableRow>
            ...
            <TableHeaderCell className="text-center">Buy (₹)</TableHeaderCell>
            <TableHeaderCell className="text-right">Sale (₹)</TableHeaderCell>
            <TableHeaderCell className="text-center">Buy</TableHeaderCell>
            <TableHeaderCell className="text-center">Sell</TableHeaderCell>
          </TableRow>
        </TableHead>
          ...
          {salesPeople
            ...
            .map((item) => (
              <TableRow key={item.date}>
                ...
                <TableCell className="text-right">{/* {item.buy} */}<NumberInput placeholder='Buying Price' /></TableCell>
                <TableCell className="text-right">{item.sale}</TableCell>
                <TableCell className="text-center"><Button>Buy</Button></TableCell>
